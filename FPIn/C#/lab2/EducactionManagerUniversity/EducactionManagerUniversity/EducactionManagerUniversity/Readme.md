...
### EducactionManagerUniversity.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [EducactionManagerUniversity.Sample.csproj](../EducactionManagerUniversity.Sample/EducactionManagerUniversity.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### EducactionManagerUniversity.Tests
