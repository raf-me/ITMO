...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<EducactionManagerUniversity.SampleSyntaxAnalyzer,
        EducactionManagerUniversity.SampleCodeFixProvider>;

namespace EducactionManagerUniversity.Tests;
