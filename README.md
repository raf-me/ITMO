...
9. [физика: Механика (3 сем)]()
10. Проектирование и взаимодействие в UX/UI (3 сем)
...
12. [Базы данных (4 сем)]()
13. [Объектно-ориентированное программирование (4 сем)]()
14. [Компьютерные сети (4 сем)](https://github.com/raf-me/ITMO/tree/main/FPIn/Computer%20networks)
15. [Методы визуализации данных (4 сем)]()
16. [Электричество и магнетизм (4 сем)]
17. [Введение в исследование популярной музыки (4 сем)]()
...
2. Основы анализа данных и программирования на Python (1 сем)
3. [Дискретная математика (1-4 сем)](https://github.com/raf-me/ITMO/tree/main/ТПП/Дискретная%20математика/)
4. Продвинутый анализ данных и программирование на Python (2 сем)
5. Архитектура ЭВМ (2 сем)
6. [Аппаратное обеспечение вычислительных систем (3 сем)](https://github.com/raf-me/ITMO/tree/main/ТПП/Аппаратное%20обеспечение%20вычислительных%20систем/)
8. Сервис-Ориентированная архитектура на Java (3 сем)
9. [Основы C/C++ (4 сем)](https://github.com/raf-me/ITMO/tree/main/ТПП/Программирование%20на%20C%2B%2B/)
10. Веб-программирование (5-6 сем)
