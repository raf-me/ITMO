...
3. Архитектура ЭВМ (3 сем)
4. Сервис-Ориентированная архитектура на Java (3 сем)
5. [Основы программирования на C++ (4 сем)](https://github.com/raf-me/ITMO/tree/main/ТПП/Программирование%20на%20C%2B%2B/)
6. Веб-программирование (5-6 сем)
